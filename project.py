...
class Db:
    ...
    def default_data(self):
        usr = [
            (1, 'Раскольников Михаил Степанович','+79487561238','Raskolnikov@mail.ru', 75000),
            (2, 'Лещенко Андрей Никтович','+79181234589','Leshenko@mail.ru', 55000),
            (3, 'Глощенко Петор Антонович','+790075149621','Gloshenko@mail.ru', 70000),
            (4, 'Кружилина Диана Александровна','+792874596289','Kruzhilina@mail.ru', 50000),
            (5, 'Макисменко Клим Валерьевич','+79507955223','Maksimenko@mail.ru', 100000)
        ]
        query_insert = '''
